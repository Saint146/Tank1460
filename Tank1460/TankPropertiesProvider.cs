...
public static class TankPropertiesProvider
{
    ...
    private static readonly Dictionary<TankType, TankProperties> TankTypePropertiesMap = new()
    {
        ...
        { TankType.Type5, new TankProperties(0.50, 1, ShellSpeed.Normal, ShellDamage.Normal) },
        { TankType.Type6, new TankProperties(1.00, 1, ShellSpeed.Fast, ShellDamage.Normal) },
